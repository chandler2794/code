function [find_z,find_nz,find_x,find_nx,find_y,find_ny]=define_direction_inside(B,q,ID,standard_vector)
...
vector66 =  B(ID(6,q),3:5)-B(q,3:5);
vector = [vector11;vector22;vector33;vector44;vector55;vector66];
